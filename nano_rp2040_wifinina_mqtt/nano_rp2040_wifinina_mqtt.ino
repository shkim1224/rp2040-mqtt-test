/*
  ...
  This example connects to a MQTT broker and publishes a message to   a topic once a second.
  The circuit:
...
char ssid[] = "iptime_shkim_24" ;        // your network SSID (name)
char pass[] = "ksh89377" ;    // your network password (use for WPA, or use as key for WEP)
...
const char broker[] = "192.168.0.2";   // mqtt_broker가 실행되고 있는 jeston 또는 rapa 의 내부 ip address
int        port     = 1883;            // mqtt_broker의 포트
const char topic[]  = "arduino";       // topic 이름
